...
NEBULA_DOCS_PATTERN = re.compile(r"^\$DOCS_URL/(.*)\.html(#.*)?$")
...
# `scripts/extract_classes.py` (nebulaengine/nebula-editor-l10n repo) to include them in the source POT file.
BASE_STRINGS = [
    "All classes",
    "Globals",
    "Nodes",
...
# Sync with the types mentioned in https://docs.nebulaengine.org/en/stable/tutorials/scripting/c_sharp/c_sharp_differences.html
...
def make_rst_class(class_def: ClassDef, state: State, dry_run: bool, output_dir: str) -> None:
    ...
    with open(
        ...
        source_github_url = f"https://github.com/nebulaengine/nebula/tree/{git_branch}/{source_xml_path}"
        generator_github_url = f"https://github.com/nebulaengine/nebula/tree/{git_branch}/doc/tools/make_rst.py"

        f.write(".. DO NOT EDIT THIS FILE!!!\n")
        f.write(".. Generated automatically from Nebula Engine sources.\n")
...
def make_link(url: str, title: str) -> str:
    match = NEBULA_DOCS_PATTERN.search(url)
    if match:
        groups = match.groups()

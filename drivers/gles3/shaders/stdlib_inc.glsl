...
// Compatibility renames. These are exposed with the "nebula_" prefix
// to work around two distinct Adreno bugs:
// 1. Some Adreno devices expose ES310 functions in ES300 shaders.
//    Internally, we must use the "nebula_" prefix, but user shaders
...
#define packUnorm4x8 nebula_packUnorm4x8
#define unpackUnorm4x8 nebula_unpackUnorm4x8
#define packSnorm4x8 nebula_packSnorm4x8
#define unpackSnorm4x8 nebula_unpackSnorm4x8
#define packHalf2x16 nebula_packHalf2x16
#define unpackHalf2x16 nebula_unpackHalf2x16
#define packUnorm2x16 nebula_packUnorm2x16
#define unpackUnorm2x16 nebula_unpackUnorm2x16
#define packSnorm2x16 nebula_packSnorm2x16
#define unpackSnorm2x16 nebula_unpackSnorm2x16

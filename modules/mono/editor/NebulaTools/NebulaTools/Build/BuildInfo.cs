...
namespace NebulaTools.Build
{
    ...
    public sealed partial class BuildInfo : RefCounted // TODO Remove RefCounted once we have proper serialization
    {
        ...
        public Nebula.Collections.Array CustomProperties { get; private set; } = new();

        public string LogsDirPath => NebulaSharpDirs.LogsDirPathFor(Solution, Configuration);
        ...
        // Needed for instantiation from Nebula, after reloading assemblies
        private BuildInfo()
        {

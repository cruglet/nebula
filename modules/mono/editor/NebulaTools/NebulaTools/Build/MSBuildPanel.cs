...
#nullable enable
        ...
        public void BuildProject()
        {
            ...
            NebulaSharpEditor.Instance.GetNode<HotReloadAssemblyWatcher>("HotReloadAssemblyWatcher").RestartTimer();
        ...
        private void OpenLogsFolder() => OS.ShellOpen(
            $"file://{NebulaSharpDirs.LogsDirPathFor("Debug")}"
        );
        ...
        public void OnBeforeSerialize()
        {
            ...
            // NOTE:
            // Currently, NebulaTools is loaded in its own load context. This load context is not reloaded, but the script still are.

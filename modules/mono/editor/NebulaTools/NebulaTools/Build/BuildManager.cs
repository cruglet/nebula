...
namespace NebulaTools.Build
{
    public static class BuildManager
    {
        ...
        {
            var dllName = $"{NebulaSharpDirs.ProjectAssemblyName}.dll";
            var path = Path.Combine(NebulaSharpDirs.ProjectBaseOutputPath, "Debug", dllName);
        ...
        {
            var plugin = NebulaSharpEditor.Instance;
        ...
        {
            var buildInfo = new BuildInfo(NebulaSharpDirs.ProjectSlnPath, NebulaSharpDirs.ProjectCsProjPath, configuration,
            ...
            if (platform != null || Utils.OS.PlatformNameMap.TryGetValue(OS.GetName(), out platform))
                buildInfo.CustomProperties.Add($"NebulaTargetPlatform={platform}");

            if (Internal.NebulaIsRealTDouble())
                buildInfo.CustomProperties.Add("NebulaFloat64=true");
        ...
        public static bool EditorBuildCallback()
        {
            ...
            if (NebulaSharpEditor.Instance.SkipBuildBeforePlaying)

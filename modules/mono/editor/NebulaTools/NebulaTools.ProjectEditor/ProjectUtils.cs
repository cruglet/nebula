...
namespace NebulaTools.ProjectEditor
{
    ...
    public static class ProjectUtils
    {
        ...
        public static void EnsureNebulaSdkIsUpToDate(MSBuildProject project)
        {
            var root = project.Root;
            string nebulaSdkAttrValue = ProjectGenerator.NebulaSdkAttrValue;

            if (!string.IsNullOrEmpty(root.Sdk) &&
                root.Sdk.Trim().Equals(nebulaSdkAttrValue, StringComparison.OrdinalIgnoreCase))
                return;

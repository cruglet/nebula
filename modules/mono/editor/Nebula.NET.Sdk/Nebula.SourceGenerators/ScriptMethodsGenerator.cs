...
namespace Nebula.SourceGenerators
{
    ...
    public class ScriptMethodsGenerator : ISourceGenerator
    {
        ...
        {
            if (context.IsNebulaSourceGeneratorDisabled("ScriptMethods"))
                return;
        ...
        private class MethodOverloadEqualityComparer : IEqualityComparer<NebulaMethodData>
        {
            public bool Equals(NebulaMethodData x, NebulaMethodData y)
                => x.ParamTypes.Length == y.ParamTypes.Length && x.Method.Name == y.Method.Name;

            public int GetHashCode(NebulaMethodData obj)
            {
                unchecked
                {
        ...
        )
        {
            ...
            var nebulaClassMethods = methodSymbols.WhereHasNebulaCompatibleSignature(typeCache)
            ...
            var distinctMethodNames = nebulaClassMethods
            ...
            // Generate GetNebulaMethodList

            if (nebulaClassMethods.Length > 0)
            {
                const string ListType = "global::System.Collections.Generic.List<global::Nebula.Bridge.MethodInfo>";

                source.Append("    /// <summary>\n")
                    .Append("    /// Get the method information for all the methods declared in this class.\n")
                    .Append("    /// This method is used by Nebula to register the available methods in the editor.\n")
                ...
                source.Append("    internal new static ")
                    .Append(ListType)
                    .Append(" GetNebulaMethodList()\n    {\n");

                source.Append("        var methods = new ")
                    .Append(ListType)
                    .Append("(")
                    .Append(nebulaClassMethods.Length)
                    .Append(");\n");

                foreach (var method in nebulaClassMethods)
                {
            ...
            if (nebulaClassMethods.Length > 0)
            {
                ...
                source.Append("    [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]\n");
                source.Append("    protected override bool InvokeNebulaClassMethod(in nebula_string_name method, ");
                source.Append("NativeVariantPtrArgs args, out nebula_variant ret)\n    {\n");
                ...
                source.Append("        return base.InvokeNebulaClassMethod(method, args, out ret);\n");

                source.Append("    }\n");
            }

            // Generate InvokeNebulaClassStaticMethod

            var nebulaClassStaticMethods = nebulaClassMethods.Where(m => m.Method.IsStatic).ToArray();

            if (nebulaClassStaticMethods.Length > 0)
            {
                source.Append("#pragma warning disable CS0109 // Disable warning about redundant 'new' keyword\n");
                source.Append("    [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]\n");
                source.Append("    internal new static bool InvokeNebulaClassStaticMethod(in nebula_string_name method, ");
                source.Append("NativeVariantPtrArgs args, out nebula_variant ret)\n    {\n");

                foreach (var method in nebulaClassStaticMethods)
                {
                    GenerateMethodInvoker(method, source);
                }
            ...
            if (distinctMethodNames.Length > 0)
            {
                source.Append("    /// <inheritdoc/>\n");
                source.Append("    [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]\n");
                source.Append("    protected override bool HasNebulaClassMethod(in nebula_string_name method)\n    {\n");
                ...
                source.Append("        return base.HasNebulaClassMethod(method);\n");
        ...
        private static void AppendMethodInfo(StringBuilder source, MethodInfo methodInfo)
        {
            ...
            source.Append(", flags: (global::Nebula.MethodFlags)")
        ...
        {
            source.Append("new(type: (global::Nebula.Variant.Type)")
            ...
            {
                source.Append(", className: new global::Nebula.StringName(\"")
        ...
        private static MethodInfo DetermineMethodInfo(NebulaMethodData method)
        {
        ...
        private static PropertyInfo DeterminePropertyInfo(MarshalType marshalType, ITypeSymbol typeSymbol, string name)
        {
            ...
            {
                className = namedTypeSymbol.GetNebulaScriptNativeClassName();
            }

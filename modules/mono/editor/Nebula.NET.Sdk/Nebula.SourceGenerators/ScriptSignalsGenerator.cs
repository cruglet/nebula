...
namespace Nebula.SourceGenerators
{
    ...
    public class ScriptSignalsGenerator : ISourceGenerator
    {
        ...
        {
            if (context.IsNebulaSourceGeneratorDisabled("ScriptSignals"))
                return;
        ...
        )
        {
            ...
            // Generate GetNebulaSignalList

            if (nebulaSignalDelegates.Count > 0)
            {
                ...
                source.Append("    /// <summary>\n")
                    ...
                    .Append("    /// This method is used by Nebula to register the available signals in the editor.\n")
                ...
                source.Append("    internal new static ")
                    .Append(ListType)
                    .Append(" GetNebulaSignalList()\n    {\n");

                source.Append("        var signals = new ")
                    .Append(ListType)
                    .Append("(")
                    .Append(nebulaSignalDelegates.Count)
                    .Append(");\n");

                foreach (var signalDelegateData in nebulaSignalDelegates)
                {
            ...
            // Generate RaiseNebulaClassSignalCallbacks
            ...
            if (nebulaSignalDelegates.Count > 0)
            {
                ...
                source.Append("    [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]\n");
                source.Append(
                    "    protected override void RaiseNebulaClassSignalCallbacks(in nebula_string_name signal, ");
                source.Append("NativeVariantPtrArgs args)\n    {\n");

                foreach (var signal in nebulaSignalDelegates)
                {
                    GenerateSignalEventInvoker(signal, source);
                }

                source.Append("        base.RaiseNebulaClassSignalCallbacks(signal, args);\n");
            ...
            if (nebulaSignalDelegates.Count > 0)
            {
                ...
                source.Append("        return base.HasNebulaClassSignal(signal);\n");
        ...
        private static MethodInfo DetermineMethodInfo(NebulaSignalDelegateData signalDelegateData)
        {
        ...
        private static void GenerateSignalEventInvoker(
            NebulaSignalDelegateData signal,
            StringBuilder source
        )
        {

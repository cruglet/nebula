    ...
    public static partial class Common
    {
        ...
        internal static readonly DiagnosticDescriptor ClassPartialModifierRule =
            new DiagnosticDescriptor(id: "GD0001",
                title: $"Missing partial modifier on declaration of type that derives from '{NebulaClasses.NebulaObject}'",
                messageFormat: $"Missing partial modifier on declaration of type '{{0}}' that derives from '{NebulaClasses.NebulaObject}'",
                category: "Usage",
                DiagnosticSeverity.Error,
                isEnabledByDefault: true,
                $"Classes that derive from '{NebulaClasses.NebulaObject}' must be declared with the partial modifier.",
        ...
        internal static readonly DiagnosticDescriptor OuterClassPartialModifierRule =
            new DiagnosticDescriptor(id: "GD0002",
                title: $"Missing partial modifier on declaration of type which contains nested classes that derive from '{NebulaClasses.NebulaObject}'",
                messageFormat: $"Missing partial modifier on declaration of type '{{0}}' which contains nested classes that derive from '{NebulaClasses.NebulaObject}'",
                category: "Usage",
                DiagnosticSeverity.Error,
                isEnabledByDefault: true,
                $"Classes that derive from '{NebulaClasses.NebulaObject}' and their containing types must be declared with the partial modifier.",
                helpLinkUri: string.Format(_helpLinkFormat, "GD0002"));

        public static readonly DiagnosticDescriptor MultipleClassesInNebulaScriptRule =
        ...
        public static readonly DiagnosticDescriptor GlobalClassMustDeriveFromNebulaObjectRule =
            new DiagnosticDescriptor(id: "GD0401",
                title: $"The class must derive from {NebulaClasses.NebulaObject} or a derived class",
                messageFormat: $"The class '{{0}}' must derive from {NebulaClasses.NebulaObject} or a derived class",
                category: "Usage",
                DiagnosticSeverity.Error,
                isEnabledByDefault: true,
                $"The class must derive from {NebulaClasses.NebulaObject} or a derived class. Change the base type, or remove the '[GlobalClass]' attribute.",

...
namespace Nebula.SourceGenerators.Tests;
...
public class ScriptPathAttributeGeneratorTests
{
    ...
    {
        return (
            Path.Combine("Nebula.SourceGenerators", "Nebula.SourceGenerators.ScriptPathAttributeGenerator", "AssemblyScriptTypes.generated.cs"),
            SourceText.From($$"""
            [assembly:Nebula.AssemblyHasScriptsAttribute(new System.Type[] {{{string.Join(", ", types.Select(type => $"typeof({type})"))}}})]

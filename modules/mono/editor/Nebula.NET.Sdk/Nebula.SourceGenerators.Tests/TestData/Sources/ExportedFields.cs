...
public partial class ExportedFields : NebulaObject
{
    ...
    [Export] private NebulaObject[] _fieldNebulaObjectOrDerivedArray = { null };
    ...
    // Classes
    [Export] private NebulaObject _fieldNebulaObjectOrDerived;
    [Export] private Nebula.Texture _fieldNebulaResourceTexture;
    ...
    [Export]
    private Nebula.Collections.Dictionary _fieldNebulaDictionary = new() { { "foo", 10 }, { Vector2.Up, Colors.Chocolate } };

    [Export]
    private Nebula.Collections.Array _fieldNebulaArray = new() { "foo", 10, Vector2.Up, Colors.Chocolate };

    [Export]
    private Nebula.Collections.Dictionary<string, bool> _fieldNebulaGenericDictionary = new() { { "foo", true }, { "bar", false } };

    [Export]
    private Nebula.Collections.Array<int> _fieldNebulaGenericArray = new() { 0, 1, 2, 3, 4, 5, 6 };
}

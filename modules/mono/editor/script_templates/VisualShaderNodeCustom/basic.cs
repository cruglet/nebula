...
public partial class VisualShaderNode_CLASS_ : _BASE_
{
    ...
    public override string _GetCode(Nebula.Collections.Array<string> inputVars, Nebula.Collections.Array<string> outputVars, Shader.Mode mode, VisualShader.Type type)
    {
        return "";
    }
}

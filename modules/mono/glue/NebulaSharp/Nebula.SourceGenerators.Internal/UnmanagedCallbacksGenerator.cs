...
namespace Nebula.SourceGenerators.Internal;
        ...
        foreach (var callback in data.Methods)
        {
            ...
            for (int i = 0; i < callback.Parameters.Length; i++)
            {
                ...
                if (parameter.RefKind == RefKind.Out)
                {
                    ...
                    if (IsNebulaInteropStruct(parameter.Type))
...
");
        ...
        foreach (var callback in data.Methods)
        {
            ...
            foreach (var parameter in callback.Parameters)
            {
                if (IsByRefParameter(parameter))
                {
                    if (IsNebulaInteropStruct(parameter.Type) || parameter.Type.IsValueType)
                    {
    ...
    private static bool IsNebulaInteropStruct(ITypeSymbol type) =>
        _nebulaInteropStructs.Contains(type.FullQualifiedNameOmitGlobal());
    ...
    private static readonly string[] _nebulaInteropStructs =
    {
        "Nebula.NativeInterop.nebula_ref",
        "Nebula.NativeInterop.nebula_variant_call_error",
        "Nebula.NativeInterop.nebula_variant",
        "Nebula.NativeInterop.nebula_string",
        "Nebula.NativeInterop.nebula_string_name",
        "Nebula.NativeInterop.nebula_node_path",
        "Nebula.NativeInterop.nebula_signal",
        "Nebula.NativeInterop.nebula_callable",
        "Nebula.NativeInterop.nebula_array",
        "Nebula.NativeInterop.nebula_dictionary",
        "Nebula.NativeInterop.nebula_packed_byte_array",
        "Nebula.NativeInterop.nebula_packed_int32_array",
        "Nebula.NativeInterop.nebula_packed_int64_array",
        "Nebula.NativeInterop.nebula_packed_float32_array",
        "Nebula.NativeInterop.nebula_packed_float64_array",
        "Nebula.NativeInterop.nebula_packed_string_array",
        "Nebula.NativeInterop.nebula_packed_vector2_array",
        "Nebula.NativeInterop.nebula_packed_vector3_array",
        "Nebula.NativeInterop.nebula_packed_vector4_array",
        "Nebula.NativeInterop.nebula_packed_color_array",
    };
}

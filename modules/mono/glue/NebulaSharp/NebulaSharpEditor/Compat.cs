...
{
    /// <inheritdoc cref="CreateAction(string, UndoRedo.MergeMode, NebulaObject, bool)"/>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public void CreateAction(string name, UndoRedo.MergeMode mergeMode, NebulaObject customContext)
    {

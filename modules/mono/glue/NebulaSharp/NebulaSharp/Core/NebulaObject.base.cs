...
namespace Nebula
{
    public partial class NebulaObject : IDisposable
    {
        private bool _disposed;
        private static readonly Type _cachedType = typeof(NebulaObject);

        internal IntPtr NativePtr;
        private bool _memoryOwn;

        private WeakReference<NebulaObject>? _weakReferenceToSelf;

        /// <summary>
        /// Constructs a new <see cref="NebulaObject"/>.
        /// </summary>
        public NebulaObject() : this(false)
        {
            unsafe
            {
        ...
        )
        {
            ...
            _weakReferenceToSelf = DisposablesTracker.RegisterNebulaObject(this);
        }

        internal NebulaObject(bool memoryOwn)
        {
            _memoryOwn = memoryOwn;
        }

        /// <summary>
        /// The pointer to the native instance of this <see cref="NebulaObject"/>.
        /// </summary>
        public IntPtr NativeInstance => NativePtr;

        internal static IntPtr GetPtr(NebulaObject? instance)
        {
            if (instance == null)
                return IntPtr.Zero;
        ...
        /// <summary>
        /// Disposes of this <see cref="NebulaObject"/>.
        /// </summary>
        public void Dispose()
        {
            Dispose(true);
        ...
        /// <summary>
        /// Disposes implementation of this <see cref="NebulaObject"/>.
        /// </summary>
        protected virtual void Dispose(bool disposing)
        {
            ...
            if (NativePtr != IntPtr.Zero)
            {
                IntPtr gcHandleToFree = NativeFuncs.nebulasharp_internal_object_get_associated_gchandle(NativePtr);
                ...
                if (_memoryOwn)
                {
                    NativeFuncs.nebulasharp_internal_refcounted_disposed(NativePtr, gcHandleToFree,
                        (!disposing).ToNebulaBool());
                }
                else
                {
                    NativeFuncs.nebulasharp_internal_object_disposed(NativePtr, gcHandleToFree);
                }
            ...
            {
                DisposablesTracker.UnregisterNebulaObject(this, _weakReferenceToSelf);
            }
        }

        /// <summary>
        /// Converts this <see cref="NebulaObject"/> to a string.
        /// </summary>
        /// <returns>A string representation of this object.</returns>
        public override string ToString()
        {
            NativeFuncs.nebulasharp_object_to_string(GetPtr(this), out nebula_string str);
            using (str)
        ...
        /// </returns>
        public SignalAwaiter ToSignal(NebulaObject source, StringName signal)
        {
        ...
        internal static Type InternalGetClassNativeBase(Type t)
        {
            ...
            if (name == "NebulaSharp" || name == "NebulaSharpEditor")
                return t;

            Debug.Assert(t.BaseType is not null, "Script types must derive from a native Nebula type.");
        ...
        /// This method is used by Nebula to assign property values.
        ...
        protected internal virtual bool SetNebulaClassPropertyValue(in nebula_string_name name, in nebula_variant value)
        {
            return false;
        }
        ...
        /// This method is used by Nebula to retrieve property values.
        /// Do not call or override this method.
        /// </summary>
        ...
        /// <returns><see langword="true"/> if a property with the given name was found.</returns>
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        protected internal virtual bool GetNebulaClassPropertyValue(in nebula_string_name name, out nebula_variant value)
        {
            value = default;
            return false;
        }
        ...
        /// This method is used by Nebula to raise signals from the engine side.\n"
        /// Do not call or override this method.
        /// </summary>
        /// <param name="signal">Name of the signal to raise.</param>
        /// <param name="args">Arguments to use with the raised signal.</param>
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        protected internal virtual void RaiseNebulaClassSignalCallbacks(in nebula_string_name signal,
        ...
        {
            var typeSelf = (nebula_string_name)type.NativeValue;
            var methodSelf = (nebula_string_name)method.NativeValue;
            IntPtr methodBind = NativeFuncs.nebulasharp_method_bind_get_method(typeSelf, methodSelf);
        ...
        internal static IntPtr ClassDB_get_method_with_compatibility(StringName type, StringName method, ulong hash)
        {
            var typeSelf = (nebula_string_name)type.NativeValue;
            var methodSelf = (nebula_string_name)method.NativeValue;
            IntPtr methodBind = NativeFuncs.nebulasharp_method_bind_get_method_with_compatibility(typeSelf, methodSelf, hash);
        ...
        internal static unsafe delegate* unmanaged<IntPtr> ClassDB_get_constructor(StringName type)
        {
            ...
            var typeSelf = (nebula_string_name)type.NativeValue;
            var nativeConstructor = NativeFuncs.nebulasharp_get_class_constructor(typeSelf);
        ...
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        protected internal virtual void SaveNebulaObjectData(NebulaSerializationInfo info)
        {
        }
        ...
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        protected internal virtual void RestoreNebulaObjectData(NebulaSerializationInfo info)
        {
        }
    }
}

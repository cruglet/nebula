...
{
    /// <summary>
    /// Wrapper around Nebula's Array class, an array of Variant
...
#pragma warning restore CA1710
        ...
        IDisposable
    {
        internal nebula_array.movable NativeValue;
        ...
        public Array()
        {
            NativeValue = (nebula_array.movable)NativeFuncs.nebulasharp_array_new();
        ...
        /// <returns>A new Nebula Array.</returns>
        ...
        /// </exception>
        /// <returns>A new Nebula Array.</returns>
        public Array(ReadOnlySpan<NebulaObject> array)
        {
            if (array == null)
                throw new ArgumentNullException(nameof(array));
        ...
        private Array(nebula_array nativeValueToOwn)
        {
            NativeValue = (nebula_array.movable)(nativeValueToOwn.IsAllocated ?
                nativeValueToOwn :
                NativeFuncs.nebulasharp_array_new());
            _weakReferenceToSelf = DisposablesTracker.RegisterDisposable(this);
        }

        // Explicit name to make it very clear
        internal static Array CreateTakingOwnershipOfDisposableValue(nebula_array nativeValueToOwn)
        ...
        /// referenced in the source array. Note that any <see cref="NebulaObject"/> derived
        ...
        {
            nebula_array newArray;
            var self = (nebula_array)NativeValue;
            NativeFuncs.nebulasharp_array_duplicate(ref self, deep.ToNebulaBool(), out newArray);
        ...
        /// Note: If <paramref name="value"/> is of a reference type (<see cref="NebulaObject"/>
        ...
        /// <example>
        /// <code>
        /// var array = new Nebula.Collections.Array();
        /// array.Resize(10);
        ...
        public void Fill(Variant value)
        {
            ...
            nebula_variant variantValue = (nebula_variant)value.NativeVar;
            var self = (nebula_array)NativeValue;
            NativeFuncs.nebulasharp_array_fill(ref self, variantValue);
        }
        ...
        public Variant Max()
        {
            nebula_variant resVariant;
            var self = (nebula_array)NativeValue;
            NativeFuncs.nebulasharp_array_max(ref self, out resVariant);
        ...
        public Variant Min()
        {
            nebula_variant resVariant;
            var self = (nebula_array)NativeValue;
            NativeFuncs.nebulasharp_array_min(ref self, out resVariant);
            return Variant.CreateTakingOwnershipOfDisposableValue(resVariant);
        }
        ...
        /// <example>
        /// <code>
        /// var array = new Nebula.Collections.Array { 1, 2, 3, 4 };
        ...
        public Variant PickRandom()
        {
            nebula_variant resVariant;
            var self = (nebula_array)NativeValue;
            NativeFuncs.nebulasharp_array_pick_random(ref self, out resVariant);
            return Variant.CreateTakingOwnershipOfDisposableValue(resVariant);
        }
        ...
        {
            var self = (nebula_array)NativeValue;
            var otherVariant = (nebula_array)other.NativeValue;
            return NativeFuncs.nebulasharp_array_recursive_equal(ref self, otherVariant).ToBool();
        }
        ...
        public Error Resize(int newSize)
        {
            ...
            var self = (nebula_array)NativeValue;
            return NativeFuncs.nebulasharp_array_resize(ref self, newSize);
        }
        ...
        public void Reverse()
        {
            ...
            var self = (nebula_array)NativeValue;
            NativeFuncs.nebulasharp_array_reverse(ref self);
        }
        ...
        public void Shuffle()
        {
            ...
            var self = (nebula_array)NativeValue;
            NativeFuncs.nebulasharp_array_shuffle(ref self);
        }
        ...
        public Array GetSliceRange(int start, int end, int step = 1, bool deep = false)
        {
            nebula_array newArray;
            var self = (nebula_array)NativeValue;
            NativeFuncs.nebulasharp_array_slice(ref self, start, end, step, deep.ToNebulaBool(), out newArray);
            return CreateTakingOwnershipOfDisposableValue(newArray);
        }
        ...
        /// <example>
        /// <code>
        /// var strings = new Nebula.Collections.Array { "string1", "string2", "string10", "string11" };
        /// strings.Sort();
        ...
        public void Sort()
        {
            ...
            var self = (nebula_array)NativeValue;
            NativeFuncs.nebulasharp_array_sort(ref self);
        }
        ...
        /// <returns>A new Nebula Array with the contents of both arrays.</returns>
        ...
        public unsafe Variant this[int index]
        {
            get
            {
                GetVariantBorrowElementAt(index, out nebula_variant borrowElem);
            ...
            set
            {
                ...
                var self = (nebula_array)NativeValue;
                nebula_variant* ptrw = NativeFuncs.nebulasharp_array_ptrw(ref self);
                nebula_variant* itemPtr = &ptrw[index];
                (*itemPtr).Dispose();
        ...
        public void Add(Variant item)
        {
            ...
            nebula_variant variantValue = (nebula_variant)item.NativeVar;
            var self = (nebula_array)NativeValue;
            _ = NativeFuncs.nebulasharp_array_add(ref self, variantValue);
        }
        ...
        public void AddRange<[MustBeVariant] T>(IEnumerable<T> collection)
        {
            ...
            // If the collection is another Nebula Array, we can add the items
            // with a single interop call.
            if (collection is Array array)
            {
                var self = (nebula_array)NativeValue;
                var collectionNative = (nebula_array)array.NativeValue;
                _ = NativeFuncs.nebulasharp_array_add_range(ref self, collectionNative);
                return;
            }
            if (collection is Array<T> typedArray)
            {
                var self = (nebula_array)NativeValue;
                var collectionNative = (nebula_array)typedArray.NativeValue;
                _ = NativeFuncs.nebulasharp_array_add_range(ref self, collectionNative);
                return;
            }
        ...
        public int BinarySearch(int index, int count, Variant item)
        {
            ...
            nebula_variant variantValue = (nebula_variant)item.NativeVar;
            var self = (nebula_array)NativeValue;
            return NativeFuncs.nebulasharp_array_binary_search(ref self, index, count, variantValue);
        }
        ...
        /// <example>
        /// <code>
        /// var arr = new Nebula.Collections.Array { "inside", 7 };
        ...
        public int IndexOf(Variant item)
        {
            ...
            nebula_variant variantValue = (nebula_variant)item.NativeVar;
            var self = (nebula_array)NativeValue;
            return NativeFuncs.nebulasharp_array_index_of(ref self, variantValue);
        }
        ...
        public int IndexOf(Variant item, int index)
        {
            ...
            nebula_variant variantValue = (nebula_variant)item.NativeVar;
            var self = (nebula_array)NativeValue;
            return NativeFuncs.nebulasharp_array_index_of(ref self, variantValue, index);
        }
        ...
        public int LastIndexOf(Variant item)
        {
            ...
            nebula_variant variantValue = (nebula_variant)item.NativeVar;
            var self = (nebula_array)NativeValue;
            return NativeFuncs.nebulasharp_array_last_index_of(ref self, variantValue, Count - 1);
        }
        ...
        public int LastIndexOf(Variant item, int index)
        {
            ...
            nebula_variant variantValue = (nebula_variant)item.NativeVar;
            var self = (nebula_array)NativeValue;
            return NativeFuncs.nebulasharp_array_last_index_of(ref self, variantValue, index);
        }
        ...
        public void Insert(int index, Variant item)
        {
            ...
            nebula_variant variantValue = (nebula_variant)item.NativeVar;
            var self = (nebula_array)NativeValue;
            NativeFuncs.nebulasharp_array_insert(ref self, index, variantValue);
        }
        ...
        public void RemoveAt(int index)
        {
            ...
            var self = (nebula_array)NativeValue;
            NativeFuncs.nebulasharp_array_remove_at(ref self, index);
        }
        ...
        public void MakeReadOnly()
        {
            ...
            var self = (nebula_array)NativeValue;
            NativeFuncs.nebulasharp_array_make_read_only(ref self);
        }
        ...
        {
            var self = (nebula_array)NativeValue;
            NativeFuncs.nebulasharp_array_to_string(ref self, out nebula_string str);
            using (str)
        ...
        /// <paramref name="index"/> is less than 0 or greater than the array's size.
        /// </exception>
        internal void GetVariantBorrowElementAt(int index, out nebula_variant elem)
        {
            if (index < 0 || index >= Count)
                throw new ArgumentOutOfRangeException(nameof(index));
        ...
        /// The variant returned via the <paramref name="elem"/> parameter is owned by the Array and must not be disposed.
        /// </summary>
        internal unsafe void GetVariantBorrowElementAtUnchecked(int index, out nebula_variant elem)
        {
    ...
    internal interface IGenericNebulaArray
    {
        public Array UnderlyingArray { get; }
    }

    /// <summary>
    /// Typed wrapper around Nebula's Array class, an array of Variant
    /// typed elements allocated in the engine in C++. Useful when
    /// interfacing with the engine. Otherwise prefer .NET collections
    ...
    public sealed class Array<[MustBeVariant] T> :
        ...
        IGenericNebulaArray
    {
        private static nebula_variant ToVariantFunc(in Array<T> nebulaArray) =>
            VariantUtils.CreateFromArray(nebulaArray);

        private static Array<T> FromVariantFunc(in nebula_variant variant) =>
        ...
        Array IGenericNebulaArray.UnderlyingArray => _underlyingArray;

        internal ref nebula_array.movable NativeValue
        {
        ...
        // Explicit name to make it very clear
        internal static Array<T> CreateTakingOwnershipOfDisposableValue(nebula_array nativeValueToOwn)
        ...
        /// <returns>A new Nebula Array, or <see langword="null"/> if <see paramref="from"/> was null.</returns>
        ...
        /// <example>
        /// <code>
        /// var array = new Nebula.Collections.Array&lt;int&gt;();
        /// array.Resize(10);
        /// array.Fill(0); // Initialize the 10 elements to 0.
        /// </code>
        /// </example>
        ...
        public void Fill(T value)
        {
            ...
            nebula_variant variantValue = VariantUtils.CreateFrom(value);
            var self = (nebula_array)_underlyingArray.NativeValue;
            NativeFuncs.nebulasharp_array_fill(ref self, variantValue);
        }
        ...
        /// <example>
        /// <code>
        /// var array = new Nebula.Collections.Array&lt;int&gt; { 1, 2, 3, 4 };
        /// GD.Print(array.PickRandom()); // Prints either of the four numbers.
        /// </code>
        /// </example>
        /// <returns>A random element from the array.</returns>
        ...
        /// <example>
        /// <code>
        /// var strings = new Nebula.Collections.Array&lt;string&gt; { "string1", "string2", "string10", "string11" };
        /// strings.Sort();
        /// GD.Print(strings); // Prints [string1, string10, string11, string2]
        /// </code>
        /// </example>
        ...
        public unsafe T this[int index]
        {
            get
            {
                _underlyingArray.GetVariantBorrowElementAt(index, out nebula_variant borrowElem);
        ...
        public int IndexOf(T item, int index)
        {
            ...
            nebula_variant variantValue = VariantUtils.CreateFrom(item);
            var self = (nebula_array)_underlyingArray.NativeValue;
            return NativeFuncs.nebulasharp_array_index_of(ref self, variantValue, index);
        }
        ...
        public void AddRange(IEnumerable<T> collection)
        {
            ...
            {
                var self = (nebula_array)_underlyingArray.NativeValue;
                var collectionNative = (nebula_array)typedArray._underlyingArray.NativeValue;
                _ = NativeFuncs.nebulasharp_array_add_range(ref self, collectionNative);
                return;
            }
        ...
        /// <example>
        /// <code>
        /// var arr = new Nebula.Collections.Array&lt;string&gt; { "inside", "7" };
        /// GD.Print(arr.Contains("inside")); // True
        /// GD.Print(arr.Contains("outside")); // False
        /// GD.Print(arr.Contains(7)); // False
        /// GD.Print(arr.Contains("7")); // True
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Array<T>(Variant from) => from.AsNebulaArray<T>();

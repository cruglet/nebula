...
{
    /// <summary>
    /// Wrapper around Nebula's Dictionary class, a dictionary of Variant
    ...
    public sealed class Dictionary :
        ...
        IDisposable
    {
        internal nebula_dictionary.movable NativeValue;
        ...
        public Dictionary()
        {
            NativeValue = (nebula_dictionary.movable)NativeFuncs.nebulasharp_dictionary_new();
            _weakReferenceToSelf = DisposablesTracker.RegisterDisposable(this);
        }

        private Dictionary(nebula_dictionary nativeValueToOwn)
        {
            NativeValue = (nebula_dictionary.movable)(nativeValueToOwn.IsAllocated ?
                nativeValueToOwn :
                NativeFuncs.nebulasharp_dictionary_new());
            _weakReferenceToSelf = DisposablesTracker.RegisterDisposable(this);
        }

        // Explicit name to make it very clear
        internal static Dictionary CreateTakingOwnershipOfDisposableValue(nebula_dictionary nativeValueToOwn)
        ...
        /// referenced in the source dictionary. Note that any <see cref="NebulaObject"/> derived
        /// elements will be shallow copied regardless of the <paramref name="deep"/>
        /// setting.
        /// </summary>
        /// <param name="deep">If <see langword="true"/>, performs a deep copy.</param>
        /// <returns>A new Nebula Dictionary.</returns>
        public Dictionary Duplicate(bool deep = false)
        {
            nebula_dictionary newDictionary;
            var self = (nebula_dictionary)NativeValue;
            NativeFuncs.nebulasharp_dictionary_duplicate(ref self, deep.ToNebulaBool(), out newDictionary);
        ...
        public void Merge(Dictionary dictionary, bool overwrite = false)
        {
            ...
            var self = (nebula_dictionary)NativeValue;
            var other = (nebula_dictionary)dictionary.NativeValue;
            NativeFuncs.nebulasharp_dictionary_merge(ref self, in other, overwrite.ToNebulaBool());
        }
        ...
        {
            var self = (nebula_dictionary)NativeValue;
            var otherVariant = (nebula_dictionary)other.NativeValue;
            return NativeFuncs.nebulasharp_dictionary_recursive_equal(ref self, otherVariant).ToBool();
        }
        ...
        public ICollection<Variant> Keys
        {
            get
            {
                nebula_array keysArray;
                var self = (nebula_dictionary)NativeValue;
                NativeFuncs.nebulasharp_dictionary_keys(ref self, out keysArray);
        ...
        public ICollection<Variant> Values
        {
            get
            {
                nebula_array valuesArray;
                var self = (nebula_dictionary)NativeValue;
                NativeFuncs.nebulasharp_dictionary_values(ref self, out valuesArray);
        ...
        private (Array keys, Array values, int count) GetKeyValuePairs()
        {
            ...
            nebula_array valuesArray;
            NativeFuncs.nebulasharp_dictionary_keys(ref self, out valuesArray);
            var values = Array.CreateTakingOwnershipOfDisposableValue(valuesArray);

            int count = NativeFuncs.nebulasharp_dictionary_count(ref self);
        ...
        public Variant this[Variant key]
        {
            get
            {
                ...
                if (NativeFuncs.nebulasharp_dictionary_try_get_value(ref self,
                        (nebula_variant)key.NativeVar, out nebula_variant value).ToBool())
                {
            ...
            set
            {
                ...
                var self = (nebula_dictionary)NativeValue;
                NativeFuncs.nebulasharp_dictionary_set_value(ref self,
                    (nebula_variant)key.NativeVar, (nebula_variant)value.NativeVar);
            }
        }
        ...
        public void Add(Variant key, Variant value)
        {
            ...
            var variantKey = (nebula_variant)key.NativeVar;
            var self = (nebula_dictionary)NativeValue;

            if (NativeFuncs.nebulasharp_dictionary_contains_key(ref self, variantKey).ToBool())
                throw new ArgumentException("An element with the same key already exists.", nameof(key));

            nebula_variant variantValue = (nebula_variant)value.NativeVar;
            NativeFuncs.nebulasharp_dictionary_add(ref self, variantKey, variantValue);
        }
        ...
        public void Clear()
        {
            ...
            var self = (nebula_dictionary)NativeValue;
            NativeFuncs.nebulasharp_dictionary_clear(ref self);
        }
        ...
        {
            var self = (nebula_dictionary)NativeValue;
            return NativeFuncs.nebulasharp_dictionary_contains_key(ref self, (nebula_variant)key.NativeVar).ToBool();
        }

        bool ICollection<KeyValuePair<Variant, Variant>>.Contains(KeyValuePair<Variant, Variant> item)
        {
            nebula_variant variantKey = (nebula_variant)item.Key.NativeVar;
            var self = (nebula_dictionary)NativeValue;
            bool found = NativeFuncs.nebulasharp_dictionary_try_get_value(ref self,
                variantKey, out nebula_variant retValue).ToBool();
            ...
            using (retValue)
            {
                ...
                nebula_variant variantValue = (nebula_variant)item.Value.NativeVar;
                return NativeFuncs.nebulasharp_variant_equals(variantValue, retValue).ToBool();
            }
        }
        ...
        public bool Remove(Variant key)
        {
            ...
            var self = (nebula_dictionary)NativeValue;
            return NativeFuncs.nebulasharp_dictionary_remove_key(ref self, (nebula_variant)key.NativeVar).ToBool();
        }
        ...
        bool ICollection<KeyValuePair<Variant, Variant>>.Remove(KeyValuePair<Variant, Variant> item)
        {
            ...
            using (retValue)
            {
                ...
                nebula_variant variantValue = (nebula_variant)item.Value.NativeVar;
                if (NativeFuncs.nebulasharp_variant_equals(variantValue, retValue).ToBool())
                {
                    return NativeFuncs.nebulasharp_dictionary_remove_key(
        ...
        public int Count
        {
            ...
            {
                var self = (nebula_dictionary)NativeValue;
                return NativeFuncs.nebulasharp_dictionary_count(ref self);
            }
        }
        ...
        public void MakeReadOnly()
        {
            ...
            var self = (nebula_dictionary)NativeValue;
            NativeFuncs.nebulasharp_dictionary_make_read_only(ref self);
        }
        ...
        public bool TryGetValue(Variant key, out Variant value)
        {
            var self = (nebula_dictionary)NativeValue;
            bool found = NativeFuncs.nebulasharp_dictionary_try_get_value(ref self,
                (nebula_variant)key.NativeVar, out nebula_variant retValue).ToBool();
        ...
        {
            var self = (nebula_dictionary)NativeValue;
            NativeFuncs.nebulasharp_dictionary_key_value_pair_at(ref self, index,
                out nebula_variant key,
                out nebula_variant value);
        ...
        {
            var self = (nebula_dictionary)NativeValue;
            NativeFuncs.nebulasharp_dictionary_to_string(ref self, out nebula_string str);
            using (str)
    ...
    internal interface IGenericNebulaDictionary
    {
        public Dictionary UnderlyingDictionary { get; }
    }

    /// <summary>
    /// Typed wrapper around Nebula's Dictionary class, a dictionary of Variant
    /// typed elements allocated in the engine in C++. Useful when
    ...
    public class Dictionary<[MustBeVariant] TKey, [MustBeVariant] TValue> :
        ...
        IGenericNebulaDictionary
    {
        private static nebula_variant ToVariantFunc(in Dictionary<TKey, TValue> nebulaDictionary) =>
            VariantUtils.CreateFromDictionary(nebulaDictionary);

        private static Dictionary<TKey, TValue> FromVariantFunc(in nebula_variant variant) =>
        ...
        Dictionary IGenericNebulaDictionary.UnderlyingDictionary => _underlyingDict;

        internal ref nebula_dictionary.movable NativeValue
        {
        ...
        internal static Dictionary<TKey, TValue> CreateTakingOwnershipOfDisposableValue(
            nebula_dictionary nativeValueToOwn)
        ...
        /// <returns>A new Nebula Dictionary, or <see langword="null"/> if <see paramref="from"/> was null.</returns>
        ...
        public TValue this[TKey key]
        {
            get
            {
                ...
                var self = (nebula_dictionary)_underlyingDict.NativeValue;

                if (NativeFuncs.nebulasharp_dictionary_try_get_value(ref self,
                        variantKey, out nebula_variant value).ToBool())
                {
                    using (value)
        ...
        public ICollection<TKey> Keys
        {
            get
            {
                nebula_array keyArray;
                var self = (nebula_dictionary)_underlyingDict.NativeValue;
                NativeFuncs.nebulasharp_dictionary_keys(ref self, out keyArray);
        ...
        public bool ContainsKey(TKey key)
        {
            using var variantKey = VariantUtils.CreateFrom(key);
            var self = (nebula_dictionary)_underlyingDict.NativeValue;
            return NativeFuncs.nebulasharp_dictionary_contains_key(ref self, variantKey).ToBool();
        }
        ...
        public bool Remove(TKey key)
        {
            ...
            using var variantKey = VariantUtils.CreateFrom(key);
            var self = (nebula_dictionary)_underlyingDict.NativeValue;
            return NativeFuncs.nebulasharp_dictionary_remove_key(ref self, variantKey).ToBool();
        }
        ...
        public static explicit operator Dictionary<TKey, TValue>(Variant from) =>
            from.AsNebulaDictionary<TKey, TValue>();

...
namespace Nebula
{
    ...
    public static partial class GD
    {
        ...
        public static Variant BytesToVar(Span<byte> bytes)
        {
            ...
            NativeFuncs.nebulasharp_bytes_to_var(varBytes, nebula_bool.False, out nebula_variant ret);
        ...
        {
            using var varBytes = Marshaling.ConvertSystemArrayToNativePackedByteArray(bytes);
            NativeFuncs.nebulasharp_bytes_to_var(varBytes, nebula_bool.True, out nebula_variant ret);
            return Variant.CreateTakingOwnershipOfDisposableValue(ret);
        }
        ...
        /// <example>
        /// <code>
        /// Variant a = new Nebula.Collections.Array { 4, 2.5, 1.2 };
        ...
        {
            NativeFuncs.nebulasharp_convert((nebula_variant)what.NativeVar, (int)type, out nebula_variant ret);
            return Variant.CreateTakingOwnershipOfDisposableValue(ret);
        }
        ...
        {
            return NativeFuncs.nebulasharp_hash((nebula_variant)var.NativeVar);
        }
        ...
        {
            using var nebulaStr = Marshaling.ConvertStringToNative(what);
            NativeFuncs.nebulasharp_print(nebulaStr);
        }
        ...
        /// <example>
        /// <code>
        /// var a = new Nebula.Collections.Array { 1, 2, 3 };
        ...
        {
            using var nebulaStr = Marshaling.ConvertStringToNative(what);
            NativeFuncs.nebulasharp_print_rich(nebulaStr);
        }
        ...
        {
            using var nebulaStr = Marshaling.ConvertStringToNative(what);
            NativeFuncs.nebulasharp_printerr(nebulaStr);
        }
        ...
        {
            using var nebulaStr = Marshaling.ConvertStringToNative(what);
            NativeFuncs.nebulasharp_printraw(nebulaStr);
        }
        ...
        public static void PrintS(params object[] what)
        {
            ...
            using var nebulaStr = Marshaling.ConvertStringToNative(message);
            NativeFuncs.nebulasharp_prints(nebulaStr);
        }
        ...
        public static void PrintT(params object[] what)
        {
            string message = AppendPrintParams('\t', what);
            using var nebulaStr = Marshaling.ConvertStringToNative(message);
            NativeFuncs.nebulasharp_printt(nebulaStr);
        }

        [StackTraceHidden]
        private static void ErrPrintError(string message, nebula_error_handler_type type = nebula_error_handler_type.ERR_HANDLER_ERROR)
        {
            ...
            using nebula_string messageStr = Marshaling.ConvertStringToNative(message);
            using nebula_string callerNameStr = Marshaling.ConvertStringToNative(callerName);
            using nebula_string callerFilePathStr = Marshaling.ConvertStringToNative(callerFilePath);
            NativeFuncs.nebulasharp_err_print_error(callerNameStr, callerFilePathStr, callerLineNumber, messageStr, p_type: type);
        }

        /// <summary>
        /// Pushes an error message to Nebula's built-in debugger and to the OS terminal.
        ///
        ...
        /// <summary>
        /// Pushes a warning message to Nebula's built-in debugger and to the OS terminal.
        /// </summary>
        /// <example>
        /// <code>
        ...
        {
            ErrPrintError(message, type: nebula_error_handler_type.ERR_HANDLER_WARNING);
        }
        ...
        {
            ErrPrintError(AppendPrintParams(what), type: nebula_error_handler_type.ERR_HANDLER_WARNING);
        }
        ...
        {
            return NativeFuncs.nebulasharp_randf();
        }
        ...
        {
            return NativeFuncs.nebulasharp_randfn(mean, deviation);
        }
        ...
        {
            return NativeFuncs.nebulasharp_randi();
        }
        ...
        {
            NativeFuncs.nebulasharp_randomize();
        }
        ...
        {
            return NativeFuncs.nebulasharp_randf_range(from, to);
        }
        ...
        {
            return NativeFuncs.nebulasharp_randi_range(from, to);
        }
        ...
        {
            return NativeFuncs.nebulasharp_rand_from_seed(seed, out seed);
        }
        ...
        /// <example>
        /// <code>
        /// ulong mySeed = (ulong)GD.Hash("Nebula Rocks");
        /// GD.Seed(mySeed);
        ...
        {
            NativeFuncs.nebulasharp_seed(seed);
        }
        ...
        /// var b = GD.StrToVar(a).AsNebulaDictionary(); // b is a Dictionary
        ...
        {
            using var nebulaStr = Marshaling.ConvertStringToNative(str);
            NativeFuncs.nebulasharp_str_to_var(nebulaStr, out nebula_variant ret);
            return Variant.CreateTakingOwnershipOfDisposableValue(ret);
        }
        ...
        {
            NativeFuncs.nebulasharp_var_to_bytes((nebula_variant)var.NativeVar, nebula_bool.False, out var varBytes);
            using (varBytes)
        ...
        {
            NativeFuncs.nebulasharp_var_to_bytes((nebula_variant)var.NativeVar, nebula_bool.True, out var varBytes);
            using (varBytes)
                return Marshaling.ConvertNativePackedByteArrayToSystemArray(varBytes);
        }
        ...
        /// <example>
        /// <code>
        /// var a = new Nebula.Collections.Dictionary { ["a"] = 1, ["b"] = 2 };
        ...
        {
            NativeFuncs.nebulasharp_var_to_str((nebula_variant)var.NativeVar, out nebula_string ret);
            using (ret)

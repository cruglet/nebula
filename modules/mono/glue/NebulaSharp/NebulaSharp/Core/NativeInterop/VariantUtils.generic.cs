...
public partial class VariantUtils
{
    ...
    {
        public static unsafe nebula_variant ToVariant(in T from) =>
            ToVariantCb != null ? ToVariantCb(from) : throw UnsupportedType<T>();

        public static unsafe T FromVariant(in nebula_variant variant) =>
            FromVariantCb != null ? FromVariantCb(variant) : throw UnsupportedType<T>();

        // ReSharper disable once StaticMemberInGenericType
        internal static unsafe delegate*<in T, nebula_variant> ToVariantCb;

        // ReSharper disable once StaticMemberInGenericType
        internal static unsafe delegate*<in nebula_variant, T> FromVariantCb;
    ...
    public static nebula_variant CreateFrom<[MustBeVariant] T>(in T from)
    {
        ...
        if (typeof(T) == typeof(Nebula.Collections.Dictionary))
            return CreateFromDictionary(UnsafeAs<Nebula.Collections.Dictionary>(from));

        if (typeof(T) == typeof(Nebula.Collections.Array))
            return CreateFromArray(UnsafeAs<Nebula.Collections.Array>(from));

        if (typeof(T) == typeof(Variant))
            return NativeFuncs.nebulasharp_variant_new_copy((nebula_variant)UnsafeAs<Variant>(from).NativeVar);
        ...
        if (typeof(NebulaObject).IsAssignableFrom(typeof(T)))
            return CreateFromNebulaObject(UnsafeAs<NebulaObject>(from));
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static T ConvertTo<[MustBeVariant] T>(in nebula_variant variant)
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        if (typeof(NebulaObject).IsAssignableFrom(typeof(T)))
            return (T)(object)ConvertToNebulaObject(variant);

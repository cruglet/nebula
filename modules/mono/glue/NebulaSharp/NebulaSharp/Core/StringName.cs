...
namespace Nebula
{
    ...
    {
        internal nebula_string_name.movable NativeValue;
        ...
        private StringName(nebula_string_name nativeValueToOwn)
        {
            NativeValue = (nebula_string_name.movable)nativeValueToOwn;
            _weakReferenceToSelf = DisposablesTracker.RegisterDisposable(this);
        }

        // Explicit name to make it very clear
        internal static StringName CreateTakingOwnershipOfDisposableValue(nebula_string_name nativeValueToOwn)
        ...
        public StringName(string name)
        {
            ...
            {
                NativeValue = (nebula_string_name.movable)NativeFuncs.nebulasharp_string_name_new_from_string(name);
                _weakReferenceToSelf = DisposablesTracker.RegisterDisposable(this);
            }
        }
        ...
        public override string ToString()
        {
            ...
            var src = (nebula_string_name)NativeValue;
            NativeFuncs.nebulasharp_string_name_as_string(out nebula_string dest, src);
            using (dest)
        ...
        public static bool operator ==(StringName? left, in nebula_string_name right)
        {
            if (left is null)
        ...
        public static bool operator ==(in nebula_string_name left, StringName? right)
        {
            return right == left;
        }
        ...
        public bool Equals(in nebula_string_name other)
        {

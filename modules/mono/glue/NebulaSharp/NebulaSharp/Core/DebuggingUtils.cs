...
namespace Nebula
{
    internal static class DebuggingUtils
    {
        ...
        internal static void InstallTraceListener()
        {
            ...
            Trace.Listeners.Add(new NebulaTraceListener());
        }

#pragma warning disable IDE1006 // Naming rule violation
        // ReSharper disable once InconsistentNaming
        [StructLayout(LayoutKind.Sequential)]
        internal ref struct nebula_stack_info
        {
            public nebula_string File;
            public nebula_string Func;
            public int Line;
        }

        // ReSharper disable once InconsistentNaming
        [StructLayout(LayoutKind.Sequential)]
        internal ref struct nebula_stack_info_vector
        {
            private IntPtr _writeProxy;
            private unsafe nebula_stack_info* _ptr;

            public readonly unsafe nebula_stack_info* Elements
            {
            ...
            public void Resize(int size)
            {
                ...
                var err = NativeFuncs.nebulasharp_stack_info_vector_resize(ref this, size);
                if (err != Error.Ok)
            ...
            public unsafe void Dispose()
            {
                if (_ptr == null)
                    return;
                NativeFuncs.nebulasharp_stack_info_vector_destroy(ref this);
                _ptr = null;
            }
        }
#pragma warning restore IDE1006
        ...
        internal static unsafe void GetCurrentStackInfo(void* destVector)
        {
            try
            {
                var vector = (nebula_stack_info_vector*)destVector;
                ...
                foreach (StackFrame frame in stackTrace.GetFrames())
                {
                    ...
                    nebula_stack_info* stackInfo = &vector->Elements[i];

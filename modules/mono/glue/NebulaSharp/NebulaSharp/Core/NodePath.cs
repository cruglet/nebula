...
namespace Nebula
{
    ...
    {
        internal nebula_node_path.movable NativeValue;
        ...
        private NodePath(nebula_node_path nativeValueToOwn)
        {
            NativeValue = (nebula_node_path.movable)nativeValueToOwn;
            _weakReferenceToSelf = DisposablesTracker.RegisterDisposable(this);
        }

        // Explicit name to make it very clear
        internal static NodePath CreateTakingOwnershipOfDisposableValue(nebula_node_path nativeValueToOwn)
        ...
        public NodePath(string path)
        {
            ...
            {
                NativeValue = (nebula_node_path.movable)NativeFuncs.nebulasharp_node_path_new_from_string(path);
                _weakReferenceToSelf = DisposablesTracker.RegisterDisposable(this);
            }
        }
        ...
        public override string ToString()
        {
            ...
            var src = (nebula_node_path)NativeValue;
            NativeFuncs.nebulasharp_node_path_as_string(out nebula_string dest, src);
            using (dest)
        ...
        {
            nebula_node_path propertyPath = default;
            var self = (nebula_node_path)NativeValue;
            NativeFuncs.nebulasharp_node_path_get_as_property_path(self, ref propertyPath);
        ...
        {
            var self = (nebula_node_path)NativeValue;
            NativeFuncs.nebulasharp_node_path_get_concatenated_names(self, out nebula_string names);
            using (names)
        ...
        {
            var self = (nebula_node_path)NativeValue;
            NativeFuncs.nebulasharp_node_path_get_concatenated_subnames(self, out nebula_string subNames);
            using (subNames)
        ...
        {
            var self = (nebula_node_path)NativeValue;
            NativeFuncs.nebulasharp_node_path_get_name(self, idx, out nebula_string name);
            using (name)
        ...
        {
            var self = (nebula_node_path)NativeValue;
            return NativeFuncs.nebulasharp_node_path_get_name_count(self);
        }
        ...
        {
            var self = (nebula_node_path)NativeValue;
            NativeFuncs.nebulasharp_node_path_get_subname(self, idx, out nebula_string subName);
            using (subName)
        ...
        {
            var self = (nebula_node_path)NativeValue;
            return NativeFuncs.nebulasharp_node_path_get_subname_count(self);
        }
        ...
        {
            var self = (nebula_node_path)NativeValue;
            return NativeFuncs.nebulasharp_node_path_is_absolute(self).ToBool();
        }
        ...
        public bool Equals([NotNullWhen(true)] NodePath? other)
        {
            if (other is null)
                return false;
            var self = (nebula_node_path)NativeValue;
            var otherNative = (nebula_node_path)other.NativeValue;
            return NativeFuncs.nebulasharp_node_path_equals(self, otherNative).ToBool();
        }
        ...
        {
            var self = (nebula_node_path)NativeValue;
            return NativeFuncs.nebulasharp_node_path_hash(self);
        }
    }
}

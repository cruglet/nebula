...
namespace Nebula
{
    ...
    /// It consists of a <see cref="Nebula.Basis"/> (first 3 columns) and a
    /// <see cref="Vector3"/> for the origin (last column).
    ///
    /// For more information, read this documentation article:
    /// https://docs.nebulaengine.org/en/latest/tutorials/math/matrices_and_transforms.html
    /// </summary>
    [Serializable]
    ...
    {
        /// <summary>
        /// The <see cref="Nebula.Basis"/> of this transform. Contains the X, Y, and Z basis
        ...
        /// </summary>
        /// <param name="basis">The <see cref="Nebula.Basis"/> to create the basis from.</param>
        /// <param name="origin">The origin vector, or column index 3.</param>

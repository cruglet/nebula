...
namespace Nebula
{
    ...
    public static class StringExtensions
    {
        ...
        {
            using nebula_string instanceStr = Marshaling.ConvertStringToNative(instance);
            NativeFuncs.nebulasharp_string_to_camel_case(instanceStr, out nebula_string camelCase);
            using (camelCase)
        ...
        {
            using nebula_string instanceStr = Marshaling.ConvertStringToNative(instance);
            NativeFuncs.nebulasharp_string_to_pascal_case(instanceStr, out nebula_string pascalCase);
            using (pascalCase)
        ...
        {
            using nebula_string instanceStr = Marshaling.ConvertStringToNative(instance);
            NativeFuncs.nebulasharp_string_to_snake_case(instanceStr, out nebula_string snakeCase);
            using (snakeCase)
...
#pragma warning restore CA5350
        ...
        {
            using nebula_string instanceStr = Marshaling.ConvertStringToNative(instance);
            NativeFuncs.nebulasharp_string_simplify_path(instanceStr, out nebula_string simplifiedPath);

...
namespace Nebula
{
    ...
    public struct Color : IEquatable<Color>
    {
        ...
        /// format (each byte represents a color channel).
        /// ARGB is more compatible with DirectX, but not used much in Nebula.
        /// </summary>
        ...
        /// format (each byte represents a color channel).
        /// RGBA is Nebula's default and recommended format.
        /// </summary>
        ...
        {
            return NativeFuncs.nebulasharp_color_from_ok_hsl(hue, saturation, lightness, alpha);
        }

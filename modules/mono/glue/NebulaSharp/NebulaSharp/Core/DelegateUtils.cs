...
namespace Nebula
{
    internal static class DelegateUtils
    {
        ...
        internal static nebula_bool DelegateEquals(IntPtr delegateGCHandleA, IntPtr delegateGCHandleB)
        {
            try
            {
                ...
                return (@delegateA! == @delegateB!).ToNebulaBool();
            }
            catch (Exception e)
            {
        ...
        [UnmanagedCallersOnly]
        internal static unsafe int GetArgumentCount(IntPtr delegateGCHandle, nebula_bool* outIsValid)
        {
            try
            {
                var @delegate = (Delegate?)GCHandle.FromIntPtr(delegateGCHandle).Target;
                ...
                if (argCount is null)
                {
                    *outIsValid = nebula_bool.False;
                    return 0;
                }
                *outIsValid = nebula_bool.True;
        ...
        internal static unsafe void InvokeWithVariantArgs(IntPtr delegateGCHandle, void* trampoline,
            nebula_variant** args, int argc, nebula_variant* outRet)
        {
            try
            {
                if (trampoline == null)
                ...
                var @delegate = (Delegate)GCHandle.FromIntPtr(delegateGCHandle).Target!;
                var trampolineFn = (delegate* managed<object, NativeVariantPtrArgs, out nebula_variant, void>)trampoline;

                trampolineFn(@delegate, new NativeVariantPtrArgs(args, argc), out nebula_variant ret);
        ...
        private static bool TrySerializeSingleDelegate(Delegate @delegate, [MaybeNullWhen(false)] out byte[] buffer)
        {
            ...
            switch (target)
            {
                ...
                case NebulaObject nebulaObject:
                {
                    using (var stream = new MemoryStream())
                    using (var writer = new BinaryWriter(stream))
                    {
                        writer.Write((ulong)TargetKind.NebulaObject);
                        // ReSharper disable once RedundantCast
                        writer.Write((ulong)nebulaObject.GetInstanceId());
                    ...
                    if (targetType.IsDefined(typeof(CompilerGeneratedAttribute), true))
                    {
                        ...
                        using (var writer = new BinaryWriter(stream))
                        {
                            ...
                            foreach (FieldInfo field in fields)
                            {
                                ...
                                static byte[] VarToBytes(in nebula_variant var)
                                {
                                    NativeFuncs.nebulasharp_var_to_bytes(var, nebula_bool.True, out var varBytes);
                                    using (varBytes)
        ...
        [UnmanagedCallersOnly]
        internal static unsafe nebula_bool TrySerializeDelegateWithGCHandle(IntPtr delegateGCHandle,
            nebula_array* nSerializedData)
        {
            try
            {
                var serializedData = Collections.Array.CreateTakingOwnershipOfDisposableValue(
                    NativeFuncs.nebulasharp_array_new_copy(*nSerializedData));
        ...
        [UnmanagedCallersOnly]
        internal static unsafe nebula_bool TryDeserializeDelegateWithGCHandle(nebula_array* nSerializedData,
        ...
        private static bool TryDeserializeSingleDelegate(byte[] buffer, [MaybeNullWhen(false)] out Delegate @delegate)
        {
            ...
            using (var reader = new BinaryReader(stream))
            {
                ...
                switch (targetKind)
                {
                    ...
                    case TargetKind.NebulaObject:
                    {
                        ulong objectId = reader.ReadUInt64();
                        NebulaObject? nebulaObject = NebulaObject.InstanceFromId(objectId);
                        ...
                        @delegate = Delegate.CreateDelegate(delegateType, nebulaObject, methodInfo,
                        ...
                        for (int i = 0; i < fieldCount; i++)
                        {
                            ...
                            if (fieldInfo != null)
                            {
                                ...
                                object? managedValue = RuntimeTypeConversionHelper.ConvertToObjectOfType(
                                    (nebula_variant)variantValue.NativeVar, fieldInfo.FieldType);
...
#pragma warning restore REFL045
        ...
        {
            public static nebula_variant ConvertToVariant(object? obj)
            {
                if (obj == null)
                    return default;
                ...
                switch (obj)
                {
                    ...
                    case NebulaObject[] nebulaObjectArray:
                        return VariantUtils.CreateFrom(nebulaObjectArray);
                    ...
                    case Collections.Dictionary nebulaDictionary:
                        return VariantUtils.CreateFrom(nebulaDictionary);
                    case Collections.Array nebulaArray:
                        return VariantUtils.CreateFrom(nebulaArray);
                    case Variant variant:
                        return VariantUtils.CreateFrom(variant);
                    case NebulaObject nebulaObject:
                        return VariantUtils.CreateFrom(nebulaObject);
                    case Enum @enum:
                        return VariantUtils.CreateFrom(Convert.ToInt64(@enum, CultureInfo.InvariantCulture));
                    case Collections.IGenericNebulaDictionary nebulaDictionary:
                        return VariantUtils.CreateFrom(nebulaDictionary.UnderlyingDictionary);
                    case Collections.IGenericNebulaArray nebulaArray:
                        return VariantUtils.CreateFrom(nebulaArray.UnderlyingArray);
                }
            ...
            private delegate object? ConvertToSystemObjectFunc(in nebula_variant managed);
            ...
            private static readonly System.Collections.Generic.Dictionary<Type, ConvertToSystemObjectFunc>
                ...
                {
                    [typeof(bool)] = (in nebula_variant variant) => VariantUtils.ConvertTo<bool>(variant),
                    [typeof(char)] = (in nebula_variant variant) => VariantUtils.ConvertTo<char>(variant),
                    [typeof(sbyte)] = (in nebula_variant variant) => VariantUtils.ConvertTo<sbyte>(variant),
                    [typeof(short)] = (in nebula_variant variant) => VariantUtils.ConvertTo<short>(variant),
                    [typeof(int)] = (in nebula_variant variant) => VariantUtils.ConvertTo<int>(variant),
                    [typeof(long)] = (in nebula_variant variant) => VariantUtils.ConvertTo<long>(variant),
                    [typeof(byte)] = (in nebula_variant variant) => VariantUtils.ConvertTo<byte>(variant),
                    [typeof(ushort)] = (in nebula_variant variant) => VariantUtils.ConvertTo<ushort>(variant),
                    [typeof(uint)] = (in nebula_variant variant) => VariantUtils.ConvertTo<uint>(variant),
                    [typeof(ulong)] = (in nebula_variant variant) => VariantUtils.ConvertTo<ulong>(variant),
                    [typeof(float)] = (in nebula_variant variant) => VariantUtils.ConvertTo<float>(variant),
                    [typeof(double)] = (in nebula_variant variant) => VariantUtils.ConvertTo<double>(variant),
                    [typeof(Vector2)] = (in nebula_variant variant) => VariantUtils.ConvertTo<Vector2>(variant),
                    [typeof(Vector2I)] = (in nebula_variant variant) => VariantUtils.ConvertTo<Vector2I>(variant),
                    [typeof(Rect2)] = (in nebula_variant variant) => VariantUtils.ConvertTo<Rect2>(variant),
                    [typeof(Rect2I)] = (in nebula_variant variant) => VariantUtils.ConvertTo<Rect2I>(variant),
                    [typeof(Transform2D)] = (in nebula_variant variant) => VariantUtils.ConvertTo<Transform2D>(variant),
                    [typeof(Vector3)] = (in nebula_variant variant) => VariantUtils.ConvertTo<Vector3>(variant),
                    [typeof(Vector3I)] = (in nebula_variant variant) => VariantUtils.ConvertTo<Vector3I>(variant),
                    [typeof(Basis)] = (in nebula_variant variant) => VariantUtils.ConvertTo<Basis>(variant),
                    [typeof(Quaternion)] = (in nebula_variant variant) => VariantUtils.ConvertTo<Quaternion>(variant),
                    [typeof(Transform3D)] = (in nebula_variant variant) => VariantUtils.ConvertTo<Transform3D>(variant),
                    [typeof(Vector4)] = (in nebula_variant variant) => VariantUtils.ConvertTo<Vector4>(variant),
                    [typeof(Vector4I)] = (in nebula_variant variant) => VariantUtils.ConvertTo<Vector4I>(variant),
                    [typeof(Aabb)] = (in nebula_variant variant) => VariantUtils.ConvertTo<Aabb>(variant),
                    [typeof(Color)] = (in nebula_variant variant) => VariantUtils.ConvertTo<Color>(variant),
                    [typeof(Plane)] = (in nebula_variant variant) => VariantUtils.ConvertTo<Plane>(variant),
                    [typeof(Callable)] = (in nebula_variant variant) => VariantUtils.ConvertTo<Callable>(variant),
                    [typeof(Signal)] = (in nebula_variant variant) => VariantUtils.ConvertTo<Signal>(variant),
                    [typeof(string)] = (in nebula_variant variant) => VariantUtils.ConvertTo<string>(variant),
                    [typeof(byte[])] = (in nebula_variant variant) => VariantUtils.ConvertTo<byte[]>(variant),
                    [typeof(int[])] = (in nebula_variant variant) => VariantUtils.ConvertTo<int[]>(variant),
                    [typeof(long[])] = (in nebula_variant variant) => VariantUtils.ConvertTo<long[]>(variant),
                    [typeof(float[])] = (in nebula_variant variant) => VariantUtils.ConvertTo<float[]>(variant),
                    ...
                    [typeof(Color[])] = (in nebula_variant variant) => VariantUtils.ConvertTo<Color[]>(variant),
                    [typeof(StringName[])] =
                        (in nebula_variant variant) => VariantUtils.ConvertTo<StringName[]>(variant),
                    [typeof(NodePath[])] = (in nebula_variant variant) => VariantUtils.ConvertTo<NodePath[]>(variant),
                    [typeof(Rid[])] = (in nebula_variant variant) => VariantUtils.ConvertTo<Rid[]>(variant),
                    [typeof(StringName)] = (in nebula_variant variant) => VariantUtils.ConvertTo<StringName>(variant),
                    [typeof(NodePath)] = (in nebula_variant variant) => VariantUtils.ConvertTo<NodePath>(variant),
                    [typeof(Rid)] = (in nebula_variant variant) => VariantUtils.ConvertTo<Rid>(variant),
                    [typeof(Nebula.Collections.Dictionary)] = (in nebula_variant variant) =>
                        VariantUtils.ConvertTo<Nebula.Collections.Dictionary>(variant),
                    [typeof(Nebula.Collections.Array)] =
                        (in nebula_variant variant) => VariantUtils.ConvertTo<Nebula.Collections.Array>(variant),
                    [typeof(Variant)] = (in nebula_variant variant) => VariantUtils.ConvertTo<Variant>(variant),
                };

            public static object? ConvertToObjectOfType(in nebula_variant variant, Type type)
            {
                if (_toSystemObjectFuncByType.TryGetValue(type, out var func))
                    return func(variant);

                if (typeof(NebulaObject).IsAssignableFrom(type))
                    return VariantUtils.ConvertTo<NebulaObject>(variant);

                if (typeof(NebulaObject[]).IsAssignableFrom(type))
                {
                    static NebulaObject[] ConvertToSystemArrayOfNebulaObject(in nebula_array nativeArray, Type type)
                    {
                        var array = Collections.Array.CreateTakingOwnershipOfDisposableValue(
                            NativeFuncs.nebulasharp_array_new_copy(nativeArray));

                        int length = array.Count;
                        var ret = (NebulaObject[])Activator.CreateInstance(type, length)!;

                        for (int i = 0; i < length; i++)
                            ret[i] = array[i].AsNebulaObject();

                        return ret;
                    }

                    using var nebulaArray = NativeFuncs.nebulasharp_variant_as_array(variant);
                    return ConvertToSystemArrayOfNebulaObject(nebulaArray, type);
                }
                ...
                if (type.IsGenericType)
                {
                    ...
                    if (genericTypeDef == typeof(Nebula.Collections.Dictionary<,>))
                    {
                        var ctor = type.GetConstructor(new[] { typeof(Nebula.Collections.Dictionary) });
                    ...
                    if (genericTypeDef == typeof(Nebula.Collections.Array<>))
                    {
                        var ctor = type.GetConstructor(new[] { typeof(Nebula.Collections.Array) });
                        ...
                        return ctor.Invoke(new object?[]
                        {
                            VariantUtils.ConvertTo<Nebula.Collections.Array>(variant)
                        });
                    }
                }

...
namespace Nebula
{
    public partial class NebulaObject
    {
        /// <summary>
        /// Returns the <see cref="NebulaObject"/> that corresponds to <paramref name="instanceId"/>.
        ...
        /// <returns>The <see cref="NebulaObject"/> instance.</returns>
        public static NebulaObject? InstanceFromId(ulong instanceId)
        {
            return InteropUtils.UnmanagedGetManaged(NativeFuncs.nebulasharp_instance_from_id(instanceId));
        }

        /// <summary>
        /// Returns <see langword="true"/> if the <see cref="NebulaObject"/> that corresponds
        ...
        /// valid <see cref="NebulaObject"/> (e.g. has not been deleted from memory).
        /// </summary>
        /// <param name="instance">The instance to check.</param>
        /// <returns>If the instance is a valid object.</returns>
        public static bool IsInstanceValid(NebulaObject? instance)
        {
        ...
        /// <returns>
        /// The <see cref="Nebula.WeakRef"/> reference to the object or <see langword="null"/>.
        /// </returns>
        public static WeakRef? WeakRef(NebulaObject? obj)
        {
            if (!IsInstanceValid(obj))
                return null;

            NativeFuncs.nebulasharp_weakref(GetPtr(obj), out nebula_ref weakRef);
            using (weakRef)
            {
                if (weakRef.IsNull)
                    return null;

...
func _add_error_window() -> void:
	...
	scale_changed.connect(func() -> void:
			error_window.size = error_window.content_scale_size * NebulaConfig.scale
			error_window.content_scale_factor = NebulaConfig.scale
	)
...
func _show_error(message: String, conf_message: String = "Ok", log_err: bool = true) -> void:
	...
	error_window.content_scale_factor = NebulaConfig.scale
	error_window.size *= NebulaConfig.scale
...
func _add_popup_window() -> void:
	...
	scale_changed.connect(func() -> void:
			popup_window.size = popup_window.content_scale_size * NebulaConfig.scale
			popup_window.content_scale_factor = NebulaConfig.scale
	)
...
func _show_popup(content: Control) -> void:
	...
	popup_window.size = content.size * NebulaConfig.scale

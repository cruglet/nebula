...
# Base Nebula dependencies path
# If cross-compiling (no LOCALAPPDATA), we install in `bin`
deps_folder = os.getenv("LOCALAPPDATA")
if deps_folder:
    deps_folder = os.path.join(deps_folder, "Nebula", "build_deps")
else:
    deps_folder = os.path.join("bin", "build_deps")

# Mesa NIR
# Check for latest version: https://github.com/nebulaengine/nebula-nir-static/releases/latest
mesa_version = "23.1.9"
mesa_filename = "nebula-nir-23.1.9.zip"
...
urllib.request.urlretrieve(
    f"https://github.com/nebulaengine/nebula-nir-static/releases/download/{mesa_version}/{mesa_filename}",
    mesa_archive,
)
...
print('\x1b[92mYou can now build Nebula with Direct3D 12 support enabled by running "scons d3d12=yes".\x1b[0m')

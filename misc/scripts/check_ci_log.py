...
if (
    ...
    print("FATAL ERROR: Nebula has been crashed.")
    sys.exit(52)

# Finding memory leaks in Nebula is quite difficult, because we need to take into
...
# It may happen that Nebula detects leaking nodes/resources and removes them, so
...
# For now Nebula leaks a lot of rendering stuff so for now we just show info

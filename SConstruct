...
opts.Add(BoolVariable("production", "Set defaults to build Nebula for use in production", False))
...
opts.Add("vsproj_name", "Name of the Visual Studio solution", "nebula")
...
if env["platform"] == "osx":
    ...
    print_warning('Platform "osx" has been renamed to "macos" in Nebula 4. Building for platform "macos".')
    env["platform"] = "macos"

if env["platform"] == "iphone":
    # Deprecated alias kept for compatibility.
    print_warning('Platform "iphone" has been renamed to "ios" in Nebula 4. Building for platform "ios".')
    env["platform"] = "ios"

if env["platform"] in ["linux", "bsd", "x11"]:
    if env["platform"] == "x11":
        # Deprecated alias kept for compatibility.
        print_warning('Platform "x11" has been renamed to "linuxbsd" in Nebula 4. Building for platform "linuxbsd".')
    # Alias for convenience.
    env["platform"] = "linuxbsd"

if env["platform"] == "javascript":
    # Deprecated alias kept for compatibility.
    print_warning('Platform "javascript" has been renamed to "web" in Nebula 4. Building for platform "web".')
    env["platform"] = "web"
...
if methods.using_gcc(env):
    if cc_version_major == -1:
        ...
        print_error(
            ...
            "C++17, or has bugs when compiling Nebula. Supported versions are 9 "
...
# Disable exception handling. Nebula doesn't use exceptions anywhere, and this
